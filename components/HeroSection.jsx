          ...
          >
            <h1 className="font-extrabold">
              ...
              <TypeWritter
                ...
                onInit={(typewriter) => {
                    typewriter
                    .typeString`<span style="color:#7860ff">Data Analyst</span>`
                    .pauseFor(1500)
                    .deleteAll()
                    .typeString`<span style="color:#8b60ff">Data Scientist</span>`
                    .pauseFor(1500)
                    .deleteAll()
                    .typeString`<span style="color:#c73bff">Software Engineer</span>`
                    .pauseFor(1500)
                    .deleteAll()
                    .start();
            ...
            <p className="text-gray-300 pt-8 text-base sm:text-lg mb-6 lg:text-xl">
              ...
              <Link
                ...
                className="px-6 inline-block py-3 rounded-full mr-4 border-solid border-2  border-purple-500 hover:bg-purple-400">
